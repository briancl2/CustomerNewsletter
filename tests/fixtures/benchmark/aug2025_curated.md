...
-   **Model availability updates (`GA` and `PREVIEW`)** – Completions now use the GPT 4.1 Copilot model (`GA`) and Gemini 2.5 Pro is available for Copilot with admin enablement (`GA`). Preview models include OpenAI GPT 5, GPT 5 mini, Grok Code Fast 1, and Anthropic Claude Opus 4.1. - [[Changelog, completions on GPT 4.1]](https://github.blog/changelog/2025-08-27-copilot-code-completion-now-uses-the-gpt-4-1-copilot-model/) [[Changelog, Gemini 2.5 Pro]](https://github.blog/changelog/2025-08-19-gemini-2-5-pro-is-generally-available-in-copilot) [[Changelog, GPT 5]](https://github.blog/changelog/2025-08-12-openai-gpt-5-is-now-available-in-public-preview-in-visual-studio-jetbrains-ides-xcode-and-eclipse/) [[Changelog, GPT 5 mini]](https://github.blog/changelog/2025-08-13-gpt-5-mini-now-available-in-github-copilot-in-public-preview/) [[Changelog, Grok Code Fast 1]](https://github.blog/changelog/2025-08-26-grok-code-fast-1-is-rolling-out-in-public-preview-for-github-copilot/) [[Changelog, Claude Opus 4.1]](https://github.blog/changelog/2025-08-05-anthropic-claude-opus-4-1-is-now-in-public-preview-in-github-copilot/)
...
| Date | Time (CT) | Event | Categories |
|------|-----------|-------|-----------|
| Sep 02 | 11:00 PM–12:30 AM | [Episode 1 - Build Smarter, Ship Faster — with GitHub Copilot Agent Mode](https://developer.microsoft.com/en-us/reactor/events/26239/) | Copilot, Developer Productivity |
| Sep 04 | 11:00 PM | [Copilot Friday: Unlocking Deep Context with Copilot Spaces](https://github.registration.goldcast.io/series/ff0939de-f20a-4395-80ff-4bc606e356fd#Text%20Grid%204) | Copilot, Developer Productivity |
| Sep 10 | 1:00 PM–2:00 PM | [Securing the Vibe Coding Era with GitHub and Endor Labs](https://developer.microsoft.com/en-us/reactor/events/26275/) | GHAS, Security |
| Sep 11 | 6:30 AM–7:30 AM | [Prompt Like a Pro: Learn Prompt Engineering Techniques to Unlock AI's Full Potential](https://developer.microsoft.com/en-us/reactor/events/26222/) | Developer Productivity, Copilot |
| Sep 11 | 9:00 AM | [AppSec Monthly (GHAS) — September Session](https://github.registration.goldcast.io/series/2ed693c3-190b-460d-a387-9ead110ba0c3) | GHAS |
| Sep 11 | 10:00 AM–12:00 PM | [VS Code Live: 1.104 Release](https://developer.microsoft.com/en-us/reactor/events/26211/) | Developer Productivity |
| Sep 18 | 11:00 PM | [Copilot Friday: Which Copilot is right for you? Demystifying the Editions](https://github.registration.goldcast.io/series/ff0939de-f20a-4395-80ff-4bc606e356fd#Text%20Grid%204) | Copilot |
| Sep 23 | 7:30 AM–8:30 AM | [VS Code Dev Days: APAC](https://developer.microsoft.com/en-us/reactor/events/26203/) | Developer Productivity |
| Sep 25 | 11:00 AM–12:00 PM | [VS Code Dev Days: Worldwide](https://developer.microsoft.com/en-us/reactor/events/26230/) | Developer Productivity, Copilot |
| Oct 09 | 9:00 AM | [AppSec Monthly (GHAS) — October Session](https://github.registration.goldcast.io/series/2ed693c3-190b-460d-a387-9ead110ba0c3) | GHAS |
| Oct 16 | 10:00 AM–12:00 PM | [VS Code Live: 1.105 Release](https://developer.microsoft.com/en-us/reactor/events/26212/) | Developer Productivity |
| Oct 23 | 12:00 PM–1:00 PM | [Python + AI: Model Context Protocol](https://developer.microsoft.com/en-us/reactor/events/26300/) | Platform |
| Nov 13 | 9:00 AM | [AppSec Monthly (GHAS) — November Session](https://github.registration.goldcast.io/series/2ed693c3-190b-460d-a387-9ead110ba0c3) | GHAS |
| Dec 11 | 9:00 AM | [AppSec Monthly (GHAS) — December Session](https://github.registration.goldcast.io/series/2ed693c3-190b-460d-a387-9ead110ba0c3) | GHAS |

### Upcoming In-person Events

- San Francisco, CA — **Oct 28–29** — [GitHub Universe 2025](https://githubuniverse.com/) (Hybrid, virtual attendance available)
  Two-day developer event with keynotes, sessions, and product announcements at Fort Mason Center. Categories: Product Roadmap, Developer Productivity.
- San Francisco, CA — **Sep 29–30** — [Git Merge 2025](https://git-merge.com/) (Hybrid, virtual attendance available)
  Celebrating 20 years of Git with talks for maintainers and enterprise-scale teams. Categories: Platform, Developer Productivity.
- Chicago, IL — **Sep 25** — [Microsoft AI Tour — Chicago](https://aitour.microsoft.com/flow/microsoft/chicago26/landingpage/page/cityhome)
  Free, one-day AI event at McCormick Place with keynotes, breakouts, and hands-on sessions. Categories: Platform, Developer Productivity.
- Mississauga, ON (Toronto area) — **Oct 01** — [Microsoft AI Tour — Toronto](https://aitour.microsoft.com/flow/microsoft/toronto26/landingpage/page/cityhome)
  Free, one-day AI event at The International Centre with keynotes and technical sessions. Categories: Platform, Developer Productivity.
- Frankfurt, Germany — **Date TBA** — [Microsoft AI Tour — Frankfurt](https://aitour.microsoft.com/flow/microsoft/frankfurt26/landingpage/page/cityhome)
  City page accessible; agenda and date not visible without sign-in at this time. Categories: Platform.
